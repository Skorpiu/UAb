 ...
 */
 ...
 const CINZA = 0xe0e0e0;
 const VERDE = 0xe5ffcc;
 ...
 function inicializa() {
	 ...
	 scene.background = new THREE.Color(BRANCO);
   ...
   // grelha
	 ...
	 const colorir = {
		 PAR: new THREE.LineBasicMaterial({ color: CINZA, linewidth: 10 }),
		 IMPAR: new THREE.LineBasicMaterial({ color: VERDE, linewidth: 10 }),
	 };
	 let square;
